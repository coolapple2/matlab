...
GD_Distributed_D2Dsumrate_withoutprecoder=nanmean(D2Dratearray_varyingD); %average D2Dsum rate with BF precoder
...
plot(GD_Distributed_D2Dsumrate_withoutprecoder,'-o','color','g')
grid;
...
toc
save(['GD_distributed_iter' num2str(iter) '_D' num2str(D) '_' date '.mat'] )
